defmodule GeoMeasure.Distance do
  ...
  def calculate(%Geo.PointM{coordinates: {x1, y1, _z1}}, %Geo.PointM{coordinates: {x2, y2, _z2}}) do
    calculate({x1, y1}, {x2, y2})
  end

  @spec calculate(Geo.Point.t(), Geo.PointM.t()) :: float()
  def calculate(%Geo.Point{coordinates: coord1}, %Geo.PointM{coordinates: {x2, y2, _z2}}) do
    calculate(coord1, {x2, y2})
  end

  @spec calculate(Geo.PointM.t(), Geo.Point.t()) :: float()
  def calculate(%Geo.PointM{coordinates: {x1, y1, _z1}}, %Geo.Point{coordinates: coord2}) do
